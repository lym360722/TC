<?php /*a:6:{s:55:"D:\webs\tc.com\public/themes/default/portal\\index.html";i:1555041568;s:60:"D:\webs\tc.com\public/themes/default/portal\public\base.html";i:1555035968;s:60:"D:\webs\tc.com\public/themes/default/portal\public\head.html";i:1554714960;s:59:"D:\webs\tc.com\public/themes/default/portal\public\nav.html";i:1555041221;s:62:"D:\webs\tc.com\public/themes/default/portal\public\footer.html";i:1555639833;s:62:"D:\webs\tc.com\public/themes/default/portal\public\script.html";i:1555033153;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 ?>
            ...
            <div class="main-product">
                <div class="layui-container">
                    <?php 
                        $title = explode('|',$widget['title']);
                     ?>
                    <p class="title"><?php echo $title[0]; ?><span><?php echo $title[1]; ?></span></p>
...
$portal_sub_categories_data = \app\portal\service\ApiService::subCategories($widget['vars']['category']);
 ...
 if(is_array($portal_sub_categories_data) || $portal_sub_categories_data instanceof \think\Collection || $portal_sub_categories_data instanceof \think\Paginator): $i = 0; $__LIST__ = $portal_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            ...
                            <div class="layui-col-sm6 layui-col-md3">
                                <div class="content">
                                    <div><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div>
                                    <div>
                                        <p class="label"><?php echo $vo['name']; ?></p>
                                        <p><?php echo $vo['description']; ?></p>
                                    </div>
                                    <a href="../Portal/Product_detail?id=<?php echo $vo['id']; ?>">查看产品</a>
                                </div>
                            </div>
...
<?php
      ...
      if(isset($theme_widgets['lower_part']) && $theme_widgets['lower_part']['display']){
        $widget=$theme_widgets['lower_part'];
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            ...
                            <div class="layui-col-sm6">
                                <div class="content">
                                    <div class="content-left"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div>
