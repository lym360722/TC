<?php /*a:6:{s:54:"D:\webs\tc.com\public/themes/default/portal\\news.html";i:1556004626;s:60:"D:\webs\tc.com\public/themes/default/portal\public\base.html";i:1555035968;s:60:"D:\webs\tc.com\public/themes/default/portal\public\head.html";i:1554714960;s:59:"D:\webs\tc.com\public/themes/default/portal\public\nav.html";i:1555041221;s:62:"D:\webs\tc.com\public/themes/default/portal\public\footer.html";i:1555639833;s:62:"D:\webs\tc.com\public/themes/default/portal\public\script.html";i:1555033153;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
if(is_array($__SLIDE_ITEMS__) || $__SLIDE_ITEMS__ instanceof \think\Collection || $__SLIDE_ITEMS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SLIDE_ITEMS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="banner news" style="background:url(<?php echo cmf_get_image_url($vo['image']); ?>) no-repeat center top;background-size: cover;">
      <div class="title">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <?php
     if(isset($theme_widgets['news_conetent']) && $theme_widgets['news_conetent']['display']){
        $widget=$theme_widgets['news_conetent'];
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div class="layui-col-lg6 content">
              <div>
                <div class="news-img"><a href="../Portal/news_detail?id=<?php echo $vo['id']; ?>&cid=<?php echo $widget['vars']['category']; ?>"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></a></div><div class="news-panel">
                  <strong><a href="../Portal/news_detail?id=<?php echo $vo['id']; ?>&cid=<?php echo $widget['vars']['category']; ?>"><?php echo $vo['post_title']; ?></a></strong>
                  <p class="detail"><span><?php echo $vo['post_excerpt']; ?></span><a href="../Portal/news_detail?id=<?php echo $vo['id']; ?>&cid=<?php echo $widget['vars']['category']; ?>">[详细]</a></p>
                 <p class="read-push"> <!--阅读 <span>120</span>&nbsp;&nbsp;&nbsp;&nbsp;-->发布时间：<span><?php echo date('Y-m-d',!is_numeric($vo['published_time'])? strtotime($vo['published_time']) : $vo['published_time']); ?></span>&nbsp&nbsp<span>分类：</span><span><?php echo $widget['title']; ?></span></p>
                </div>
              </div>
            </div>
            
<?php endforeach; endif; else: echo "" ;endif;      if(isset($theme_widgets['news_coneten']) && $theme_widgets['news_coneten']['display']){
        $widget=$theme_widgets['news_coneten'];
