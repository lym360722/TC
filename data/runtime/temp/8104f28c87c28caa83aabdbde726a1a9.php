<?php /*a:6:{s:57:"D:\webs\tc.com\public/themes/default/portal\\product.html";i:1556004445;s:60:"D:\webs\tc.com\public/themes/default/portal\public\base.html";i:1555035968;s:60:"D:\webs\tc.com\public/themes/default/portal\public\head.html";i:1554714960;s:59:"D:\webs\tc.com\public/themes/default/portal\public\nav.html";i:1555041221;s:62:"D:\webs\tc.com\public/themes/default/portal\public\footer.html";i:1555639833;s:62:"D:\webs\tc.com\public/themes/default/portal\public\script.html";i:1555033153;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
if(is_array($__SLIDE_ITEMS__) || $__SLIDE_ITEMS__ instanceof \think\Collection || $__SLIDE_ITEMS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SLIDE_ITEMS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="banner product" style="background:url(<?php echo cmf_get_image_url($vo['image']); ?>) no-repeat center top;background-size: cover;">
      <div class="title">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
 ...
 $portal_sub_categories_data = \app\portal\service\ApiService::subCategories($widget['vars']['category']);
 
 if(is_array($portal_sub_categories_data) || $portal_sub_categories_data instanceof \think\Collection || $portal_sub_categories_data instanceof \think\Paginator): $i = 0; $__LIST__ = $portal_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;$articles_data = \app\portal\service\ApiService::articles([
    'field'   => '',
    'where'   => "",
    'limit'   => '5',
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div class="content layui-row">
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md7 layui-col-lg6 content-img">
                <img src="<?php echo cmf_get_image_url($vo['more']['photos'][0]['url']); ?>" width="260px" height="260px">
              </div>
              <div class="layui-col-xs12 layui-col-sm6 layui-col-md5 layui-col-lg6 right">
                <p class="label"><?php echo $vo['post_title']; ?></p>
                <p class="detail"><?php echo $vo['post_content']; ?></p>
                <!-- <br /><br />
                <div><a href="../Portal/Product_detail?id=<?php echo $vo['id']; ?>">查看产品详情 ></a></div> -->
              </div>
            </div>
