<?php /*a:2:{s:77:"D:\webs\tc.com\public/themes/admin_simpleboot3/portal\admin_article\edit.html";i:1553741833;s:65:"D:\webs\tc.com\public/themes/admin_simpleboot3/public\header.html";i:1552118035;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="<?php echo url('AdminArticle/editPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php 
    \think\facade\Hook::listen('portal_admin_article_edit_view_main',null,null,false);
 ?>
            </div>
            <div class="col-md-3">
                <table class="table table-bordered">
                ...
                <?php 
    \think\facade\Hook::listen('portal_admin_article_edit_view_right_sidebar',null,null,false);
 ?>
            </div>
        </div>
