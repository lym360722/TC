<?php /*a:6:{s:54:"D:\webs\tc.com\public/themes/default/portal\\case.html";i:1556004625;s:60:"D:\webs\tc.com\public/themes/default/portal\public\base.html";i:1555035968;s:60:"D:\webs\tc.com\public/themes/default/portal\public\head.html";i:1554714960;s:59:"D:\webs\tc.com\public/themes/default/portal\public\nav.html";i:1555041221;s:62:"D:\webs\tc.com\public/themes/default/portal\public\footer.html";i:1555639833;s:62:"D:\webs\tc.com\public/themes/default/portal\public\script.html";i:1555033153;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
if(is_array($__SLIDE_ITEMS__) || $__SLIDE_ITEMS__ instanceof \think\Collection || $__SLIDE_ITEMS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SLIDE_ITEMS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="banner case" style="background:url(<?php echo cmf_get_image_url($vo['image']); ?>) no-repeat center top;background-size: cover;">
      <div class="title">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <?php
     if(isset($theme_widgets['case_conetent']) && $theme_widgets['case_conetent']['display']){
        $widget=$theme_widgets['case_conetent'];
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div class="layui-inline content">
              <div class="layui-inline case-img"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div>
              <p class="lable"><?php echo $vo['post_title']; ?></p>
