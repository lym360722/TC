<?php /*a:6:{s:55:"D:\webs\tc.com\public/themes/default/portal\\about.html";i:1556004621;s:60:"D:\webs\tc.com\public/themes/default/portal\public\base.html";i:1555035968;s:60:"D:\webs\tc.com\public/themes/default/portal\public\head.html";i:1554714960;s:59:"D:\webs\tc.com\public/themes/default/portal\public\nav.html";i:1555041221;s:62:"D:\webs\tc.com\public/themes/default/portal\public\footer.html";i:1555639833;s:62:"D:\webs\tc.com\public/themes/default/portal\public\script.html";i:1555033153;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
if(is_array($__SLIDE_ITEMS__) || $__SLIDE_ITEMS__ instanceof \think\Collection || $__SLIDE_ITEMS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SLIDE_ITEMS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="banner about" style="background:url(<?php echo cmf_get_image_url($vo['image']); ?>) no-repeat center top;background-size: cover;">
      <div class="title">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="main-about">
      <div class="layui-container">
        <div class="layui-row">
          <ul class="aboutab">
            <li class="layui-this">公司简介</li><li>发展历程</li>
          </ul>
          
          <?php
     if(isset($theme_widgets['company_profile']) && $theme_widgets['company_profile']['display']){
        $widget=$theme_widgets['company_profile'];
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id']%2 == '0'): ?>
                  <div class="content">
                    <div class="layui-inline img"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div><div class="layui-inline panel">
                ...
                <?php else: ?>
                  <div class="content">
                    <div class="layui-inline panel p_block">
                      <p><?php echo $vo['post_excerpt']; ?></p>
                    </div><div class="layui-inline img"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div>
                      <p class="p_hidden"><?php echo $vo['post_excerpt']; ?></p>
                  </div>
                <?php endif; ?>  
...
<?php
      ...
      if(isset($theme_widgets['development_history']) && $theme_widgets['development_history']['display']){
        $widget=$theme_widgets['development_history'];
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id']%2 == '0'): ?>
                  <li class="odd">
                    <div class="cour-img"><img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></div>
                    <div class="cour-panel layui-col-sm4 layui-col-lg5">
                      <p class="label"><?php echo $vo['post_title']; ?></p>
                      <p><?php echo $vo['post_excerpt']; ?></p>
                    </div>
                  </li>
                <?php else: ?>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
              <li class="odd">
                <div class="cour-img"><img src="/themes/default/portal/res/static/img/us_img8.png"></div>
              </li>
            </ul>
          </div>
