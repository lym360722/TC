...
insert  into `cmf_hook_plugin`(`id`,`list_order`,`status`,`hook`,`plugin`) values (1,10000,1,'admin_init','AdminJournal'),(2,10000,1,'before_body_end','FloatMenuLite'),(3,10000,1,'fetch_upload_view','Qiniu'),(5,10000,1,'admin_dashboard','SystemInfo');
...
insert  into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values (1,1,0,0,1554284696,0,0,'0.00',1554168106,1,'admin','###b493138f355024e4ae05bb0607caa316','admin','3450817337@qq.com','','','','192.168.19.50','','',NULL);
