...
CREATE TABLE `cmf_slide` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='幻灯片表';

/*Data for the table `cmf_slide` */

insert  into `cmf_slide`(`id`,`status`,`delete_time`,`name`,`remark`) values (1,1,0,'首页顶部轮播图','首页顶部出现的轮播图'),(2,1,0,'首页顶部轮播图','首页顶部出现的轮播图'),(3,1,0,'底部幻灯片','底部显示二维码'),(4,1,0,'新闻详情banner','新闻详情顶部出现的banner图'),(5,1,0,'产品banner','产品页顶部出现的banner图'),(6,1,0,'动态banner','动态页顶部出现的banner图'),(7,1,0,'案列banner','案例页顶部出现的banner图'),(8,1,0,'关于banner','关于页顶部出现的banner图\r\n');
...
insert  into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values (1,1,0,0,1557049403,0,0,'0.00',1554168106,1,'admin','###b493138f355024e4ae05bb0607caa316','admin','3450817337@qq.com','','','','192.168.19.50','','',NULL);
